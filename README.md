<div align="center">
  <h1 align="center">A Visio Conferencing App</h1>
    <div align="center">
      Made with ❤️ by Nguidjol Martin, in persue of a Professionnal Qualification Diploma (PQD)
    </div>
</div>
...
```bash
git clone https://github.com/adrianhajdin/ng-connect.git
cd ng-connect
```
